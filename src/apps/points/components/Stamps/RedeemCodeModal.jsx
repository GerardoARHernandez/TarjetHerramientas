// src/apps/points/components/Stamps/RedeemCodeModal.jsx
...
const RedeemCodeModal = ({ 
    ...
    const requiredStamps = redeemData.campaign?.CampaCantPSCanje || 0;
            ...
            >
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">
                        Has canjeado {requiredStamps} sellos por una recompensa
                    </p>
                </div>
                ...
                {redeemData.campaign && (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-sm font-medium" style={{ color: detallesColor }}>
                                Recompensa obtenida:
                            </span>
                        </div>
                        <p className="font-bold text-lg" style={{ color: detallesColor }}>
                            {redeemData.campaign.CampaRecompensa}
                        </p>
                        <p className="text-sm text-gray-600 mt-1">
                            {redeemData.campaign.CampaNombre}
                        </p>
                    </div>
                )}
                ...
                <div className="mb-6">
                    <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        >
                            <p className="text-xs text-gray-600 mb-1">Sellos canjeados</p>
                            <p className="font-bold text-lg" style={{ color: color2 }}>
                                {requiredStamps}
                            </p>
                        </div>
                        <div 
                        ...
                        >
                            ...
                            <p className="font-bold text-lg" style={{ color: color1 }}>
                                Sellos
                            </p>
                        </div>
                    </div>
                ...
                > 
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        <li>• Válido hasta: {redeemData.campaign ? new Date(redeemData.campaign.CampaVigeFin).toLocaleDateString() : 'No especificado'}</li>
                    </ul>
                </div>
