...
import { X, CreditCard, DollarSign, CheckCircle, Gift } from 'lucide-react';
...
const RedeemPurchaseModal = ({ isOpen, onClose, businessName }) => {
    ...
    const calculatePoints = (amount) => {
        // Calcula el 10% del importe (1 punto por cada unidad monetaria)
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.webId.trim() || !formData.importe.trim()) {
        return;
        }
            ...
            <div className="p-6">
                ...
                <div className="mb-6 animate-fade-in">
                    ...
                    <p className="text-emerald-600 text-sm">
                        (10% del importe: ${formData.importe})
                    </p>
                    </div>
                </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        10% de ${formData.importe} = {calculatePoints(formData.importe)} puntos
                        </div>
                    </div>
                    )}
                    ...
                    <button
                        type="submit"
                        disabled={isSubmitting || !formData.webId.trim() || !formData.importe.trim()}
                        className="flex-1 py-3 px-4text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
