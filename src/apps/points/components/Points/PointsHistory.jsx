...
const PointsHistory = ({ accountData, detallesColor, onViewFullHistory, rules }) => {
    ...
    return (
        ...
        >
            ...
            <div 
                className="rounded-xl py-2 shadow-lg border bg-white mt-8"
                style={{
            ...
            >
                <div className="text-center">
                    <button
                        ...
                        className="text-gray-800 hover:text-gray-950 font-medium transition-colors flex items-center justify-center gap-2 mx-auto cursor-pointer">
