// src/apps/points/views/AdminPoints.jsx (actualizado)
...
const AdminPoints = () => {
  const { transactions, clients, businessStats, business, selectedClientDetails } = usePoints();
  const { user } = useAuth();
  ...
  // Manejar ver detalles del cliente
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {business && (
                <>
                  ...
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    <p className="text-sm text-indigo-600">Total Clientes</p>
                    <p className="text-2xl font-bold">{businessStats.totalClients}</p>
                  </div>
                </>
              )}
            </div>
        ...
        {/* Lista de Clientes */}
        <div className="mb-8">
          <ClientsList onViewDetails={handleViewClientDetails} />
        </div>
